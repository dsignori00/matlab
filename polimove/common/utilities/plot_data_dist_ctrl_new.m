function plot_data_dist_ctrl_new(data)
...
hold on
ylabel('vx [mph]')
plot(data.time, MPS2MPH*data.distance_ctrl_ref, 'LineWidth',1.5,'color','r', 'DisplayName','vx ref')
...
spt(4)=subplot(4,1,4);
hold on
ylabel('dist ctrl flag [-]')
xlabel('time [s]')
plot(data.time, data.distance_ctrl_emergency, 'LineWidth',1.5,'color','r', 'DisplayName','dist ref')
legend show
