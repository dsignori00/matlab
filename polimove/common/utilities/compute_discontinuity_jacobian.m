function J_tot =  compute_discontinuity_jacobian(d_knot_vec)
    ...
    J = (Nt_next_mat*C_mat*Padding_next_mat - Nt_curr_mat*C_mat*Padding_curr_mat);
    J_tot = [J zeros(N_points); zeros(N_points) J];
