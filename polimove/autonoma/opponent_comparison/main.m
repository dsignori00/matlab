close all
clearvars -except log log_ego trajDatabase ego.index opp_file
...
[fig_traj, panel_traj, checkbox_traj, popup_ego, popup_opp] = ...
    create_figures('Trajectory', checklist_strings, default_selection, max_lap, 'traj');
...
[fig_speed, panel_speed, checkbox_speed, popup_ego_speed, popup_opp_speed] = ...
    create_figures('Speed Profile', checklist_strings, default_selection, max_lap, 'speed');
...
[fig_curv, panel_curv, checkbox_curv, ~, ~] = ...
    create_figures('Acceleration Profile', checklist_strings, default_selection, max_lap, 'curv');
