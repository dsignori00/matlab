...
% Texense
[tex_t,ia,ic] = unique(log.texense__imu.omega_stamp__tot);
tex_ax = -log.texense__imu.omega(ia,2)*pi/180;
tex_ay = -log.texense__imu.omega(ia,1)*pi/180;
tex_az = -log.texense__imu.omega(ia,3)*pi/180;
tex_tot = sqrt(tex_ax.^2 + tex_ay.^2 + tex_az.^2);

% G1-pro
g1_t = log.g1pro__imu0.header__stamp__tot;
g1_ax = -log.g1pro__imu0.gx;
g1_ay = -log.g1pro__imu0.gy;
g1_az = log.g1pro__imu0.gz;
...
[g1_ps_ax, g1_ps_ax_fx] = pspectrum(g1_ax(1:2:end),g1_t(1:2:end));
[g1_ps_ay, g1_ps_ax_fy] = pspectrum(g1_ay(1:2:end),g1_t(1:2:end));
[g1_ps_az, g1_ps_ax_fz] = pspectrum(g1_az(1:2:end),g1_t(1:2:end));
