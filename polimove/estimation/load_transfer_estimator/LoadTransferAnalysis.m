...
lift_tot=lift_f+lift_r;
load_ol_f = 333 - m*ax*h/WB/9.81 + lift_f;
load_ol_r = 463 + m*ax*h/WB/9.81 + lift_r;
...
% plot(t_vfbk,2*lowpass(log.vehicle_fbk_eva__load_wheel_fl,0.1,100),'DisplayName','fl','LineWidth',0.5);
% plot(t_vfbk,2*lowpass(log.vehicle_fbk_eva__load_wheel_fr,0.1,100),'DisplayName','fr','LineWidth',0.5);
plot(t_vfbk,lowpass(load_meas_f,0.1,100),'DisplayName','meas_filt');
...
plot(t_vfbk,lowpass(load_meas_r,0.1,100),'DisplayName','meas_filt');
