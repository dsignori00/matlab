...
lid_clust.yaw_rel_gt = interp1(gt.stamp,gt.yaw_rel,lid_clust.sens_stamp);
...
rad_clust.yaw_rel_gt = interp1(gt.stamp,gt.yaw_rel,rad_clust.sens_stamp);
rad_clust.rho_dot_gt = interp1(gt.stamp,gt.rho_dot,rad_clust.sens_stamp);
...
rad_clust.rho_dot_err = rad_clust.rho_dot-rad_clust.rho_dot_gt;
...
lid_pp.yaw_rel_gt = interp1(gt.stamp,gt.yaw_rel,lid_pp.sens_stamp);
...
cam_yolo.yaw_rel_gt = interp1(gt.stamp,gt.yaw_rel,cam_yolo.sens_stamp);
...
% unwrap on gt heading
lid_clust.yaw_map = unwrap_angle_smart(lid_clust.yaw_map,lid_clust.yaw_map_gt);
rad_clust.yaw_map = unwrap_angle_smart(rad_clust.yaw_map,rad_clust.yaw_map_gt);
lid_pp.yaw_map = unwrap_angle_smart(lid_pp.yaw_map,lid_pp.yaw_map_gt);
cam_yolo.yaw_map = unwrap_angle_smart(cam_yolo.yaw_map,cam_yolo.yaw_map_gt);
lid_clust.yaw_rel = unwrap_angle_smart(lid_clust.yaw_rel,lid_clust.yaw_rel_gt);
rad_clust.yaw_rel = unwrap_angle_smart(rad_clust.yaw_rel,rad_clust.yaw_rel_gt);
lid_pp.yaw_rel = unwrap_angle_smart(lid_pp.yaw_rel,lid_pp.yaw_rel_gt);
cam_yolo.yaw_rel = unwrap_angle_smart(cam_yolo.yaw_rel,cam_yolo.yaw_rel_gt);
