...
plot(log.control__lateral__command.bag_stamp, 180/pi * log.control__lateral__command.yaw_rate_ref_mpc,        'Color', matlab_colors(4,:), 'DisplayName','ref mpc');
plot(log.control__lateral__command.bag_stamp, 180/pi * log.control__lateral__command.yaw_rate_ref_internal,   'Color', matlab_colors(3,:), 'DisplayName','ref internal');
