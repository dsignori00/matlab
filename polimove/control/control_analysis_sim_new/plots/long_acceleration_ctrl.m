...
plot(log.control__long__command.bag_stamp, log.control__long__command.speed_ctrl_acc_ctrl/9.81,    'DisplayName', 'ctrl');
plot(log.control__long__command.bag_stamp, log.control__long__command.speed_ctrl_acc_ctrl_fb/9.81, 'DisplayName', 'ctrl fb');
plot(log.control__long__command.bag_stamp, log.control__long__command.speed_ctrl_acc_ctrl_ff/9.81, 'DisplayName', 'ctrl ff');

plot(log.control__long__command.bag_stamp, log.control__long__command.acc_ctrl_max/9.81, 'k', 'DisplayName', 'max');
plot(log.control__long__command.bag_stamp, log.control__long__command.acc_ctrl_min/9.81, 'k', 'DisplayName', 'min');

plot(log.control__long__command.bag_stamp, log.control__long__command.acc_ctrl_sat_max/9.81, 'Color',  [0.5 0.5 0.5], 'DisplayName', 'sat max');
plot(log.control__long__command.bag_stamp, log.control__long__command.acc_ctrl_sat_min/9.81, 'Color',  [0.5 0.5 0.5], 'DisplayName', 'sat min');
