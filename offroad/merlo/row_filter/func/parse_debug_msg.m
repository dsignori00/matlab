...
%PARSE_LINE_EQUATIONS Parse line equations from log structure
    ...
    out.chunks = parse_chunk_msg(log, 'perception__row_filter__debug__info', 'chunks');
    ...
    out.chunks.density_chunk_threshold = log.perception__row_filter__debug__info.density_chunk_threshold;
